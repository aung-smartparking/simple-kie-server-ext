...
public class SimpleResource {
	private static final Logger logger = LoggerFactory.getLogger(SimpleResource.class);
    ...
    public SimpleResource(RulesExecutionService rulesExecutionService, KieServerRegistry registry) {
